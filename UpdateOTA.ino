...
String update_Server_version()  {
  ...
  if (!httpClient.begin(wifiClient,"http://" + update_server + ":3000/firmware/version_parola.txt")) {
...
String update_Server_begin()  {
  ...
  t_httpUpdate_return ret = ESPhttpUpdate.update(client, update_server, 3000, "/firmware/pyramidak_parola.bin");
